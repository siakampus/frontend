...
export default function LecturerDashboardPage() {
  ...
  return (
    <AppLayout
      ...
      subtitle={`Selamat datang kembali, ${userData?.name || userData?.email || 'Dosen'}!`}
    >
      <div className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <StatCard title="Kelas Aktif" value="0" icon={<BookOpen className="h-6 w-6 text-primary" />} />
          <StatCard title="Tugas Belum Dinilai" value="0" icon={<CheckCircle className="h-6 w-6 text-orange-500" />} />
          <StatCard title="Asisten Dosen" value="0" icon={<Users className="h-6 w-6 text-green-500" />} />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card className="shadow-sm border rounded-lg">
            ...
            <CardContent className="p-4 flex flex-col gap-3">
               <Link to="#" className="text-sm font-medium text-blue-600 hover:text-blue-800 hover:underline flex items-center gap-2">
                 <BookOpen className="h-4 w-4"/> Kelola Mata Kuliah & Modul
               </Link>
               <Link to="#" className="text-sm font-medium text-blue-600 hover:text-blue-800 hover:underline flex items-center gap-2">
                 <CheckCircle className="h-4 w-4"/> Penilaian Tugas Mahasiswa
               </Link>
               <Link to="#" className="text-sm font-medium text-blue-600 hover:text-blue-800 hover:underline flex items-center gap-2">
                 <Users className="h-4 w-4"/> Kelola Asisten Dosen
               </Link>
            </CardContent>
          </Card>
          ...
          <Card className="shadow-sm border rounded-lg">
            <CardHeader className="border-b bg-muted/10 pb-4">
              <CardTitle className="text-lg flex items-center gap-2 font-serif text-primary">
                <CalendarDays className="h-5 w-5" /> Jadwal Mengajar Hari Ini
              </CardTitle>
            </CardHeader>
            <CardContent className="p-4">
              <div className="rounded-md bg-blue-50 p-4 border border-blue-100">
                <div className="flex">
                  ...
                  <div className="ml-3">
                    <h3 className="text-sm font-medium text-blue-800">Tidak ada jadwal</h3>
                    <div className="mt-2 text-sm text-blue-700">
                      <p>Anda tidak memiliki jadwal kelas hari ini.</p>
                    </div>
                  </div>
                </div>
              </div>
